...
class BranchesSearch extends Branches
{
     ...
     * @inheritdoc
     */
    //tim kiem textbox view index.php
    ...
    public function search($params)
    {
        ...
        //tim kiem textbox view index.php -> getCompaniesCompany()
        ...
        $query->andFilterWhere(['like', 'branch_name', $this->branch_name])
            ...
            ->andFilterWhere(['like', 'companies.Company_name', $this->companies_company_id]); //tim kiem textbox view index.php
